...
class Products extends React.Component{
    ...
    componentDidMount() {
        let myRequest = new Request('http://192.168.99.100:8888/collections/entries/products?q=e40f461fd0a7a62080326a8398b858');
        let initialProducts = [];
        fetch(myRequest)
            .then(response => {
            ...
            <div id="productcontainer">
                <div className="row">
                    ...
                    <div className="col-sm-10 jumbotron">
                        <h1>Välkommen till Skinshop</h1>
                        <p>Vi förser dig med dem bästa skinsen för Counter Strike</p>
                    </div>
                    <div className="col-sm-1"></div>
